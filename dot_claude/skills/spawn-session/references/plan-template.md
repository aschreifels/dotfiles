# PLAN.md Template (LEGACY)

**Superseded by the dossier ritual** (`references/dossier.md` + `{kb.root}/templates/dossier/`).
Kept only for reading legacy single-PLAN.md sessions during wrap — never use this for
new sessions.
